# Corpus — Vue cartographique d’un établissement produite par la forge des communs numériques éducatifs
...
- Original : <https://educajou.forge.apps.education.fr/ecolemap/>
- Reprise : `http://localhost:3000/education/educajou-ecolemap`
- Page du banc : `public/education/educajou-ecolemap.html`
...
> L’application de la forge n’a aucune donnée propre : elle interroge le portail. LIM-006 à la lettre
