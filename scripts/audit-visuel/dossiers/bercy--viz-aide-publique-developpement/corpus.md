# Corpus — L'aide publique au développement de la France
...
- Original : <https://data.aide-developpement.gouv.fr>
- Reprise : `http://localhost:3000/viz/aide-publique-developpement`
- Page du banc : `public/viz/aide-publique-developpement.html`
...
> Portail Opendatasoft tiers : 7 contextes → 1, carte du monde en un attribut
